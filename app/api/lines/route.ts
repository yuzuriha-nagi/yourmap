...
const lines = [
  ...
  },
  {
    ...
    stations: [
      '西鉄福岡（天神）', '薬院', '西鉄平尾', '高宮', '大橋', '井尻', '春日原', '白水', '下大利', '都府楼前', '二日市', '朝倉街道', '桜台', '筑紫野', '小郡', '大保', '津古', '三国が丘', '三沢', '大善寺', '花畑', '試験場前', '津福', '安武', '久留米', '櫛原', '西牟田', '宮の陣', '学校前', '善導寺', '筑後草野', '大城', '金島', '三潴', '犬塚', '大溝', '八丁牟田', '蒲池', '矢加部', '徳益', '沖端', '塩塚', '西鉄柳川', '東津留', '西鉄中島', '江の浦', '開', '銀水', '新栄町', '西鉄大牟田'
    ],
    bounds: {
      center: [33.31, 130.42],
      zoom: 10
